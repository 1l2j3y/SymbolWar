...
class Boss(Sprite):
    ...
    def shoot(self):
        new_boss_bullet1 = BossBullet(self.SW_game,self.rect.centerx - 30,self.rect.bottom)
        new_boss_bullet2 = BossBullet(self.SW_game,self.rect.centerx,self.rect.bottom)
        new_boss_bullet3 = BossBullet(self.SW_game,self.rect.centerx + 30,self.rect.bottom)
